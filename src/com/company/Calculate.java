...
public class Calculate{
    ...
    public void male(int currentWeight,double height , int age  ){
//        BMR = 10W + 6.25H - 5A + 5
    ...
    public void female(int currentWeight,double height, int age){
//        BMR = 10W + 6.25H - 5A - 161
    ...
    public void currentcal() {
        ...
        if(gender.equals("male")){
            male(currentWeight,height,age);

        }else if(gender.equals("female")){
            female(currentWeight, height, age);
        }
